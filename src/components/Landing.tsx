...
import VoiceIndicator from "./ui/Mic";
// import { createAiResponse, createChat } from "./util";
...
const TherapistIcon = () => (
  ...
  >
    <path
      id="XMLID_264_"
      d="M382.635,124.312l-20.171-15.946c-2.793-2.208-6.547-2.764-9.859-1.463l-26.769,10.518V75.109
...
const LoaderIcon = () => {
  return (
    <svg
      className="w-7 h-7 animate-spin text-red-600"
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
    >
    ...
    <div className="flex h-screen">
      ...
      <main className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="mt-6 flex gap-2">
          <button
            className={`px-4 py-2 text-sm rounded font-satoshi ${
              sessionMode === "classic"
        ...
        {sessionStarted ? (
          <>
            {currMessageRef.current?.text && (
              <TypingEffect
                messageRef={{ current: currMessageRef.current.text }}
                speed={100}
              />
            )}
            ...
            <div className="mt-6 min-h-[100px] w-full max-w-md bg-white p-4 flex flex-col items-center justify-between gap-4">
              ...
              {/* </p> */}
              {/* Control buttons */}
              {openListener && !showVoiceLoader && (
                <VoiceIndicator value={openListener} />
              )}
              <div
                className={`w-full bottom-4 flex flex-row justify-between items-center ${
                  isTyping ? "disabled" : "flex"
                }`}
              >
                <button
                ...
                {!openListener && !showVoiceLoader && (
                  <button
                    ...
                    className={`p-4 rounded-full bg-red-100 text-red-600 hover:bg-red-200 transition-colors flex ${
                ...
                <div className="space-y-4">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 bg-blue-50 rounded-lg p-3">
                      <p className="text-gray-900">Your message appears here</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1 bg-yellow-50 rounded-lg p-3">
                      <p className="text-gray-900">AI response appears here</p>
                    </div>
                  </div>
                </div>
              ) : (
        ...
        {sessionStarted ? null : (
          <button
            ...
            className="mt-4 bg-yellow-400 hover:bg-yellow-500 text-black font-switzer font-semibold py-2 px-6 rounded"
          >
            begin session
          </button>
        )}
